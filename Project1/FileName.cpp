...
int main()
{
    ...
    timeText.setFillColor(sf::Color::Color(255, 215, 0));
   ...
   //backgroundMusic.play();
    ...
    while (window.isOpen())
    {
        ...
        int seconds = temp % 60;
        timeText.setString(std::to_string(minutes) + ":" + (seconds < 10 ? "0" : "") + std::to_string(seconds));
        ...
        //to the up
        if ((Keyboard::isKeyPressed(Keyboard::Key::Up)) && (fireboy.getGlobalBounds().intersects(ground1.getGlobalBounds())))
        {
        ...
        if ((fireboy.getGlobalBounds().intersects(lake.getGlobalBounds())) || (fireboy.getGlobalBounds().intersects(green_goo.getGlobalBounds())))
        {
        ...
        //watergirl jumping
        if ((!watergirl.getGlobalBounds().intersects(ground1.getGlobalBounds())) &&  (!watergirl.getGlobalBounds().intersects(ground1_5.getGlobalBounds())))
        {
        ...
        if (Keyboard::isKeyPressed(Keyboard::Key::W) && ((watergirl.getGlobalBounds().intersects(ground1.getGlobalBounds()))|| (watergirl.getGlobalBounds().intersects(ground1_5.getGlobalBounds()))))
        {
        ...
        //watergirl diamonds
        {
            if (watergirl.getGlobalBounds().intersects(blueDiamond1.getGlobalBounds()))
            {
                blueDiamond1.move(9999.f, 0.f);
                diamond_sound.play();
            }
            if (watergirl.getGlobalBounds().intersects(blueDiamond2.getGlobalBounds()))
            {
                blueDiamond2.move(9999.f, 0.f);
                diamond_sound.play();
            }
            if (watergirl.getGlobalBounds().intersects(blueDiamond3.getGlobalBounds()))
            {
                blueDiamond3.move(9999.f, 0.f);
                diamond_sound.play();
            }
            if (watergirl.getGlobalBounds().intersects(blueDiamond4.getGlobalBounds()))
            {
        ...
        // watergirl death
        if ((watergirl.getGlobalBounds().intersects(lava.getGlobalBounds())) || (watergirl.getGlobalBounds().intersects(green_goo.getGlobalBounds())))
        {
